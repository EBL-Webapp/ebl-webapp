...
const OvernightSlipSection = () => {
  return (
    <div className="bg-white border border-[#4E0303] shadow-md rounded-lg p-6 font-zion text-sm text-gray-800">
      <h2 className="text-lg font-semibold text-[#4E0303] mb-4">Overnight Slip</h2>
      ...
      <div className="text-justify text-xs italic mb-15">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-6 gap-x-8">
        <div className="text-center">
          ...
          <span className="block text-xs">Signature over Printed Name (Student)</span>
        </div>
        <div className="text-center">
          <div className="border-b border-gray-400 w-2/3 mx-auto mb-1" />
          <span className="block text-xs">Signature over Printed Name (Parent/Guardian)</span>
        </div>
      </div>
    </div>
  );
