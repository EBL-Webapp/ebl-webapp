        ...
        <div className="justify-center flex mb-10 lg:col-span-2">
          <div className="w-[95%] h-fit bg-white mt-6 rounded-4xl border-2 border-black text-black">
            ...
            <div className=" border-t-3 border-b-3 mb-5 grid grid-cols-2 zain-regular lg:text-[20px] ">
              ...
              <div className="border-r-3 border-black p-1">
                ...
                <p>
                  ...
                  Nihil, aliquam. Magni ad hic dolorum consectetur quisquam
                  molestias possimus pariatur repellendus!
                </p>
              </div>
              {/* Right Part */}
              <div className="p-1">
                ...
                <p>
                  Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                  Laboriosam nobis veritatis vitae reprehenderit. Pariatur
                  quisquam ab ratione porro aut quidem amet corrupti maxime
                  dolorum. Laudantium incidunt quia cupiditate rem
                  reprehenderit!
                </p>
              </div>
            </div>
            ...
            <div className="flex justify-end mr-5">
              <button className="bg-[#4E0303] text-white rounded-2xl px-5 py-2 ml-5 mb-5 hover:bg-red-900">
                Approve
              </button>
              <button className="bg-[#4E0303] text-white rounded-2xl px-5 py-2 ml-5 mb-5  hover:bg-red-900">
                Deny
        ...
        <div className="m-4 justify-center grid grid-cols-2 gap-2 lg:col-span-1">
          ...
          <div className="border-2 border-black p-2 rounded-2xl zain-regular text-black h-fit">
            ...
            <div className="flex justify-end gap-3">
              <button className="p-2 bg-[#4E0303] mt-1 rounded-2xl text-white zain-regular w-15 hover:bg-red-900">
                Approve
              </button>
              <button className="p-2 bg-[#4E0303] mt-1 rounded-2xl text-white zain-regular w-15 hover:bg-red-900">
                Deny
